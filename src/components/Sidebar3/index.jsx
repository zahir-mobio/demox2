    ...
    <>
      <aside className={props.className}>
        <Img
          ...
          className="h-[28px] md:ml-[0] ml-[65px] mr-[87px] mt-[36px] w-[auto]"
          alt="menu"
        />
        <div className="flex flex-col items-start justify-start mb-[522px] md:ml-[0] ml-[28px] mr-[54px] mt-[36px] w-[66%]">
