  ...
  return (
    <>
      <aside className={props.className}>
        <div className="flex flex-col gap-[36px] items-center justify-start mb-[424px] ml-[29px] mr-[54px] mt-[36px] w-[66%]">
          <Img
          ...
          <div className="flex flex-col items-start justify-start w-[100%]">
            ...
            <div className="flex flex-row gap-[16px] items-start justify-start md:ml-[0] ml-[3px] mt-[32px] md:w-[100%] w-[62%]">
              <Img
                src="images/img_calendar_bluegray_100.svg"
                className="h-[20px] w-[20px]"
                alt="calendar"
              />
              <Text
                className="font-inter mt-[2px] not-italic text-bluegray_800 text-left w-[auto]"
                as="h6"
                variant="h6"
              >
                Calender
