      ...
      <header className={props.className}>
        <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-center mx-[auto] my-[10px] w-[96%]">
          ...
          <Input
            ...
            wrapClassName="bg-white_A700 border-[1px] border-bluegray_200 border-solid flex sm:hidden md:ml-[0] ml-[228px] pl-[16px] pr-[35px] py-[10px] rounded-[4px] md:w-[100%] w-[38%]"
