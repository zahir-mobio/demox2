                ...
                <div className="flex md:flex-col flex-row font-inter gap-[20px] items-center justify-between w-[100%]">
                  <div className="bg-white_A700 flex md:flex-1 items-center justify-start p-[32px] sm:px-[20px] rounded-[4px] shadow-bs md:w-[100%] w-[24%]">
                    <div className="flex flex-col items-start justify-start mb-[8px] w-[100%]">
                      ...
                      <div className="flex flex-col gap-[20px] items-start justify-start mt-[32px] md:w-[100%] w-[62%]">
                  ...
                  <div className="bg-white_A700 flex md:flex-1 items-center justify-start p-[26px] sm:px-[20px] rounded-[4px] shadow-bs md:w-[100%] w-[75%]">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[3px] md:w-[100%] w-[99%]">
                      ...
                      <div className="flex flex-col items-center justify-start w-[100%]">
                        <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start w-[100%]">
                          <List
                            className="md:flex-1 sm:flex-col flex-row sm:gap-[20px] grid sm:grid-cols-1 grid-cols-5 md:w-[100%] w-[72%]"
                            orientation="horizontal"
                          >
                            <div className="border-[1px] border-indigo_50 border-solid flex items-center justify-end sm:ml-[0] p-[13px] w-[100%]">
                              <Text
                          ...
                          <List
                            ...
                            orientation="horizontal"
                          >
                            <div className="border-[1px] border-indigo_50 border-solid flex items-center justify-end p-[13px] w-[100%]">
                              <Text
                                className="font-normal not-italic text-bluegray_800 text-center w-[auto]"
                                as="h5"
                                variant="h5"
                        ...
                        <div
                          className="bg-cover bg-no-repeat flex h-[598px] items-start justify-start p-[16px] w-[100%]"
                          style={{
                            backgroundImage: "url('images/img_group119.svg')",
                          }}
                        >
                          <div className="bg-deep_orange_300 flex items-end justify-start mb-[536px] md:ml-[0] ml-[101px] p-[4px] rounded-[4px] md:w-[100%] w-[14%]">
                            <div className="flex items-center justify-start mr-[3px] md:w-[100%] w-[85%]">
                              <div className="flex flex-row items-center justify-between py-[2px] w-[100%]">
                                <div className="bg-white_A700 h-[8px] my-[4px] rounded-[50%] w-[8px]"></div>
                                <Text
