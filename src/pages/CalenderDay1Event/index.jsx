                  ...
                  <div className="bg-white_A700 flex md:flex-1 items-center justify-start p-[26px] sm:px-[20px] rounded-[4px] shadow-bs md:w-[100%] w-[75%]">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[6px] md:w-[100%] w-[99%]">
                      ...
                      <div className="flex items-center justify-start w-[100%]">
                        <div className="border-[1px] border-indigo_50 border-solid flex flex-col gap-[13px] items-center justify-start py-[15px] w-[100%]">
                          <Text
                          ...
                          <div className="flex flex-col items-center justify-start mb-[543px] w-[100%]">
                            <Line className="bg-indigo_50 h-[1px] w-[100%]" />
                            <div className="bg-indigo_400 flex items-start justify-start mt-[3px] p-[4px] rounded-[4px] md:w-[100%] w-[99%]">
                              <div className="flex items-start justify-start md:ml-[0] ml-[12px] md:w-[100%] w-[32%]">
                                <div className="flex flex-row items-start justify-start md:w-[100%] w-[96%]">
                                  <Img
                                    src="images/img_oval.svg"
                                    className="h-[8px] mt-[5px] w-[auto]"
                                    alt="oval_Four"
                                  />
                                  <Text
                                    className="ml-[13px] not-italic text-left text-white_A700 w-[auto]"
                                    as="h6"
                                    variant="h6"
                                  >
                                    8:10 am
                                  ...
                                  <Text
                                    className="ml-[10px] mt-[2px] not-italic text-left text-white_A700 w-[auto]"
                                    as="h6"
                                    variant="h6"
                                  >
